            ...
            <div class="card" data-aos="fade-up">
              <div class="card-img-block">
                <img
                  ...
                  "
                  :alt="item.Picture.PictureDescription1 || item.ScenicSpotName"
                  class="card-img-top"
                />
              </div>
              <div class="card-body">
                ...
                <span
                  ...
                  >{{ item.OpenTime || "未提供資料" }}</span
                >
                <p class="card-text pt-3">
                  <i class="bi bi-geo-alt-fill pe-1"></i
                  >{{ item.City || item.Address.substr(0, 3) }}
                </p>
              </div>
              <a
                href="#"
                ...
                :data-bs-target="'#' + item.ScenicSpotID"
                >了解更多</a
              >
            </div>
            <div
    ...
    filterCategory() {
      switch (this.category) {
        case "所有類別":
          ...
          break;
        case "自然風景類":
          this.filterData = this.tourData.filter(
            (item) =>
